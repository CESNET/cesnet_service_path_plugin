...
urlpatterns = (
    ...
    path("service-paths/<int:pk>/edit/", ServicePathEditView.as_view(), name="servicepath_edit"),
    path("service-paths/<int:pk>/delete/", ServicePathDeleteView.as_view(), name="servicepath_delete"),
    path(
    ...
    path("segment-circuit-mappings/", SegmentCircuitMappingListView.as_view(), name="segmentcircuitmapping_list"),
    path("segment-circuit-mappings/add/", SegmentCircuitMappingEditView.as_view(), name="segmentcircuitmapping_add"),
    path("segment-circuit-mappings/<int:pk>/", SegmentCircuitMappingView.as_view(), name="segmentcircuitmapping"),
    path(
