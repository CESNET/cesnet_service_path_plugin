...
class EthernetServiceSegmentDataSerializer(NetBoxModelSerializer):
    """
    Serializer for EthernetServiceSegmentData model.

    Handles technical specifications for Ethernet service segments including
    port speed, VLAN configuration, encapsulation, interface type, and MTU.
    """
    ...
    def validate(self, data):
        """
        Validate that the segment doesn't already have ethernet service data.
        ...
        if self.instance:
            ...
            instance = EthernetServiceSegmentData(**data)
