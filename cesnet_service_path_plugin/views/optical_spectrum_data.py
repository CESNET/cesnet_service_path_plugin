...
from cesnet_service_path_plugin.forms import OpticalSpectrumSegmentDataForm
from cesnet_service_path_plugin.models import OpticalSpectrumSegmentData, Segment


@register_model_view(OpticalSpectrumSegmentData, "add", detail=False)
@register_model_view(OpticalSpectrumSegmentData, "edit")
class OpticalSpectrumSegmentDataEditView(generic.ObjectEditView):
    """
    View for adding/editing optical spectrum technical data.
    ...
    """
    queryset = OpticalSpectrumSegmentData.objects.all()
    form = OpticalSpectrumSegmentDataForm
...
@register_model_view(OpticalSpectrumSegmentData, "delete")
class OpticalSpectrumSegmentDataDeleteView(generic.ObjectDeleteView):
    """
    View for deleting optical spectrum technical data.
    """
    queryset = OpticalSpectrumSegmentData.objects.all()
