...
from cesnet_service_path_plugin.forms import DarkFiberSegmentDataForm
from cesnet_service_path_plugin.models import DarkFiberSegmentData, Segment


@register_model_view(DarkFiberSegmentData, "add", detail=False)
@register_model_view(DarkFiberSegmentData, "edit")
class DarkFiberSegmentDataEditView(generic.ObjectEditView):
    """
    View for adding/editing dark fiber technical data.
    ...
    """
    queryset = DarkFiberSegmentData.objects.all()
    form = DarkFiberSegmentDataForm
...
@register_model_view(DarkFiberSegmentData, "delete")
class DarkFiberSegmentDataDeleteView(generic.ObjectDeleteView):
    """
    View for deleting dark fiber technical data.
    """
    queryset = DarkFiberSegmentData.objects.all()
