...
[![NetBox compatibility](https://img.shields.io/badge/NetBox-4.5%20%7C%204.6%20%7C%204.7-blue.svg)](https://github.com/netbox-community/netbox)
...
|----------------|----------------|-------|
|     4.7.x      |      6.3.x     | **NetBox 4.7 only** (min_version 4.7.0) |
...
3. **NetBox 4.7.x** (for plugin version 6.3.x); **NetBox 4.5.4–4.6.x** (for plugin version 6.2.x)
   ...
   - NetBox 4.7.x requires plugin version 6.3.0 or later (6.3.x does not run on NetBox < 4.7.0)
